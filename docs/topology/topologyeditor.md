...
- в дереве топологии переходом на склад, сегмент или ячейку (при выборе сегмента или склада остатки отражаются по 
  первой в списке ячейке)
- во вкладке переходом на нужную ячейку
***
...
Открывает содержание справочника Сегменты склада
...
- В табличной части можно задать ограничения на использование видов тары, которые запрещены для хранения в ячейке. 
...
Показывает текущие остатки, хранящиеся в ячейке
